            ...
            if (pendingInvite.status === "on_the_way") {
                ...
                llmMessages.push({
                    ...
                    content: [
                        ...
                        "  * 只有在剧情自然推进到你【确实已经抵达碰头地点、站在门口敲门、或在店里亲眼看见对方】时，你可以在微信正文中明确告知对方你已在现场（例如：“我到肯德基门口了，看见你的白毛衣了，快出来吧” / “我到606门外了，开门”）；",
                        "  * 【最高铁律·只要说到了必须附带指令】：一旦你在正文中宣布到了、敲门或已在门外，【必须绝对在回复末尾附带：`[提前到达]` 或 `[提前到达:卡片到达私房心语]`】（例如：`[提前到达:我就在店门外小树旁，穿件外套慢慢走出来不着急]`），绝不可正文说到了却漏掉指令！",
