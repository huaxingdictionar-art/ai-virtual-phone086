            ...
            if (!isAlertTheme) {
                ...
                llmMessages.push({
                    ...
                    content: [
                        ...
                        isMultipleDeclines
                            ? ` - 多次连续被拒说明：当前用户已连续拒绝 ${declineCount} 次，你可以流露真实细腻的小情绪（如明显失落、疑惑对方是否在反复犹豫拉扯、打趣找补“都拒绝我${declineCount}次了真狠心~”或小耍赖再争取一下），若人设偏执或背景特殊可考虑转入红白质问，但日常情境依然不应轻易强行动身。`
