            ...
            if (pendingInvite.status === "on_the_way") {
                ...
                llmMessages.push({
                    ...
                    content: [
                        ...
                        `- 【时间一致性铁律（消弭时间割裂）】：若用户在聊天中询问你什么时候到/还要多久、或者你在回复中主动提到预估用时或路况：你口中所说的预计到达时间必须与当前手机倒计时的约 ${remainingMins} 分钟基本吻合（允许 ±5 分钟以内的自然口语与路况波动，例如倒计时15分钟，可以说“还有十几分钟就到”、“大概一刻钟左右”、“导航说差不多15到20分钟”，绝对严禁说出与 ${remainingMins} 分钟严重背离相差甚远的时间）！`,
                        "- 你们正在微信上继续沟通路况或闲聊，你可以根据人设正常回复路况（如“快到了”、“路上稍有点堵”、“正听着音乐开车呢”）。",
                        "- 【在途改地点指引】：若用户在聊天中要求临时变更碰头地点（例如：“改在607了”、“去隔壁便利店等我”）：",
                        ...
                        "  * 若在微信沟通中，剧情自然推进到了你已提前抵达现场、或你已经看到对方/看到对方所在的门面/在楼下看到对方窗户灯光（仅距数十米，只差面对面碰头）：",
                        "  * 此时你可以在微信正文中自然告知对方你已在现场（例如：“我到肯德基门口了，看见你的白毛衣了，快出来吧” / “我到你家楼下了，下楼给我开门好不好”）；",
                        "  * 请在回复末尾附带：`[提前到达]` 或 `[提前到达:卡片到达私房心语]`（例如：`[提前到达:我就在店门外小树旁，穿件外套慢慢走出来不着急]`）；",
                ...
                if (pendingInvite.direction === "i_go") {
                    ...
                    llmMessages.push({
                        ...
                        content: [
                            ...
                            "- 【用户撒娇/明确要求你来接（允许转为他来的唯一严格条件）】：",
                            "  * 若用户在聊天中明确提出希望你主动来接/来找对方（例如：“就不能是你来接我吗”、“那你过来接我嘛”、“我懒得动，你来我家楼下找我好不好”等）：",
                            "  * 说明用户把主动权交给了你，希望你主动奔赴！你根据人设做出真实自然的反应（如宠溺、无奈轻笑或立刻答应：“真拿你没办法，那你在家待着，我开车过去接你，等我二十分钟哦”）；",
                            "  * 此时【允许且必须顺理成章转为他来】！在末尾附带去对方地点的全新5段指令：`[更改地点:他来:对方地点:用时:提议由头|微信在途报备|卡片在途心语|微信到达呼唤|卡片到达心语]` 或 `[线下邀约:他来:对方地点:用时:提议由头|微信在途报备|卡片在途心语|微信到达呼唤|卡片到达心语]`，系统会自动将卡片无缝转为【他来】并在3秒后弹出全新奔赴提议！",
                    ...
                    llmMessages.push({
                        ...
                        content: [
                            ...
                            "   * 【特殊极少情况·用户转为来找你】：若用户明确提出“你别折腾了，我去找你吧 / 我去见你”，你顺从答应，并转为【我去】格式：`[更改地点:我去:新地点:现场等候语]`，系统会自动切换为你在现场等候用户！",
