    ...
    if (session.enableOfflineInvite && !session.isGroup) {
        llmMessages.push({
            ...
            content: [
                ...
                "2. 【严禁抢跑动身·提议阶段人必须在原地等待】：",
                "   - 在发起【他来】邀约的这一轮回复中，你**仅仅是在向对方“提出见面提议与询问”（征求意见阶段）**！你**人还在原地！绝对没有出门！没有动身！没有上车！更没有在路上！**",
                "   - 【绝对严禁】在正文台词中自说自话地说：“我已经开车出发了”、“我现在出门了”、“已经在路上了别着急”、“二十分钟左右到你楼下”等任何表示已经动身/出发/在途的台词！",
                "   - 必须老老实实在原地商量询问（例如：“外面雨下得太大，如果你需要的话我开车过去接你，好不好？”、“要不要我下午忙完手头这点事过去找你，我们一起去拼豆店？”）。",
                "   - 对方此时还没按下【答应Ta】！只有在后续用户在界面上真正点击答应之后，你才能动身！对方没答应前擅自说“已经出发”属于严重违背生活常理与强买强卖！",
                "3. 【索要定位/打听位置时严禁触发邀约】：",
                "   - 如果你本轮台词还在向对方询问在哪、索要定位（例如：“定位发我”、“发错给谁了？你在哪”、“在哪个屋檐下躲着”），说明你【根本还不知道对方身处何地】！",
                "   - 【绝对严禁】在还在打听定位的这一轮就猴急发起[线下邀约]！更【绝对严禁】胡乱脑补编造出“你发错定位的位置”、“未知地点”等极其滑稽出戏的病句！必须等待下一轮对方发来具体位置（如“在牛牛便利店”），你回复确认去接时再触发邀约！",
                "   - 【未知地点特别设定·深情奔赴（你身边）】：如果情境是对方遭遇紧急危险、醉酒或迷路并明确表达“不知道自己在哪里/迷路了”，而你执意要动身去寻找守护对方，碰头地点必须写作充满深情与宿命感的【你身边】（例如：`[线下邀约:他来:你身边:20分钟:找个暖和地方呆着别动，不管在哪我都去接你|车子发动了，在原地等我，我这就过去你身边|我到了，出来就能看见我]`）！绝不可写出任何生硬滑稽的机械病句！",
                "4. 【严防主客颠倒】：",
                ...
                "",
                "【格式规范】",
                "1. 若为【他来】（你动身去见用户，需要三段台词与用时）：",
                "   [线下邀约:他来:碰头地点:预计用时:提议理由|在途心语|到达呼唤]",
                "   - 【碰头地点】：结合当前上下文商定的真实地点（如“新开的拼豆店”、“老地方猫咖”、“万达写字楼”、“你家楼下”等），严禁千篇一律套用“你家楼下”！",
                "   - 【预计用时·严格一致】：必须与你在本轮正文台词中向对方许诺的时间严格保持一致！例如正文中说“等我十几分钟”，用时请写“15分钟”；若正文说“半小时内到”，用时写“30分钟”；若正文说“忙完手头这点事过去”，用时请结合生活常理写一个合宜的分数（如15分钟、20分钟）。绝对严禁正文中说十几分钟指令里却写30分钟或40分钟！",
                "   - 【提议理由】：结合当前上下文提议见面的由头（如“听说楼下新开了很可爱的拼豆店，想陪你一起去”、“想把落下的耳机还你”）。",
                "   - 【在途心语·纯粹行动报备·绝无答复词】：这是当对方在界面上点击【答应Ta】之后，你在微信发出的动身报备。此时上一句微信往往是你自己在问对方“好不好”，对方是在界面上点击了答应按钮、聊天框中并无对方新发言。因此【绝对严禁】出现“好”、“好的”、“行”、“没问题”、“知道了”、“收到”、“嗯”等任何答复性或赞同性字眼（严防角色自问自答“好不好？好”的极其突兀与尴尬）！必须直接是干净利落的动身报备与行程告知（例如：“我这就收拾东西出发过去找你，拼豆店见”、“我现在动身过去，一会儿见”、“已经在路上了，稍等我片刻”）。同时必须紧密顺承提议时的具体事情，严禁不顾情境机械套用“在家里乖乖等我”！",
                "   - 【到达呼唤·专属人设台词·严禁模板套话】：倒计时结束抵达碰头地点时，你在微信和全屏卡片上亲口呼唤对方的一句话。必须根据你的角色性格、当时碰头地点自然说话（例如：“我到拼豆店门口啦，快出来吧”、“车停在写字楼大门前了，下来就能看见我”）。【绝对严禁】千篇一律套用轻浮刻板的句式（如机械重复“穿件外套下来吧~”等）。",
                "   示例A（结伴同去某地）：[线下邀约:他来:新开的拼豆店:15分钟:听说楼下新开了很可爱的拼豆店，想陪你一起去|我这就收拾好东西出发过去找你，我们一起去拼豆店|我已经到拼豆店门口啦，快出来吧]",
                "   示例B（接送/送物）：[线下邀约:他来:万达写字楼一楼:20分钟:外面雨下太大了，开车接你回家|车子发动了，这就过去接你，在暖气大堂稍等我片刻|我到大堂门口了，打着伞出来吧]",
        ...
        let pendingInvite: { status?: string; direction?: string; place?: string } | null = null;
        try {
        ...
        if (pendingInvite) {
            if (pendingInvite.status === "on_the_way") {
                llmMessages.push({
                    role: "system",
                    content: [
                        `【你当前正在赶往见面的路上·在途状态中】：你之前已经向用户提议见面，用户已经点击【答应Ta】，你当前正处于赶往约定地点（${pendingInvite.place || "约定地点"}）的赶路途中，手机倒计时正在进行！`,
                        "- 你们正在微信上继续沟通路况或闲聊，你可以根据人设正常回复路况（如“快到了”、“路上稍有点堵”、“正听着音乐开车呢”）。",
                        "- 【绝对严禁再次发起邀约】：你已经在动身赶往见面的路上了！【绝对严禁】在回复中输出任何[线下邀约]或[提醒赴约]指令！绝不可重复发起或重复动身！倒计时结束后系统会自动提示到达。",
                    ].join("\n"),
                });
                ...
                llmMessages.push({
                    role: "system",
                    content: [
                        `【你已如约到达约定地点·等候用户】：你已经到达了约定地点（${pendingInvite.place || "约定地点"}），正在现场等候用户出来碰面。`,
                        "- 【绝对严禁再次发起邀约】：【绝对严禁】在回复中输出任何[线下邀约]或[提醒赴约]指令！用户稍后在手机上点击【去见Ta】就会直接进入线下模式与你碰面。",
                    ].join("\n"),
                });
                ...
                if (pendingInvite.direction === "i_go") {
                    ...
                    llmMessages.push({
                        role: "system",
                        content: [
                            `【线下邀约等候中·你正在等用户赴约】：你之前邀请用户前来与你碰头（碰头地点：${pendingInvite.place || "约定地点"}），用户此前已将弹窗收起，你们正在微信上继续沟通。`,
                            "- 此时是你处于现场等候状态，动身前往的是用户本人。用户可能会在聊天中向你沟通路况或进展（例如：“我快到了”、“在路上了”、“等我五分钟”等）。",
                            "- 【极其重要·严禁反复弹窗】：你只需根据你的角色性格，正常在线上温柔/自然回复对方（例如：“路上慢点，注意安全”、“不着急，我正看着书等你呢”等），【绝对严禁】再次输出[提醒赴约]或任何[线下邀约]指令！绝不反复弹窗打扰用户！用户到达现场后会自行点击顶部的赴约胶囊进入线下。",
                        ].join("\n"),
                    });
                } else {
                    ...
                    llmMessages.push({
                        role: "system",
                        content: [
                            "【线下邀约挂起等待中·你动身去见用户】：你之前向用户提出了由你前往找对方的提议，用户选择了【稍后处理】收起弹窗，你们正在线上继续沟通。",
                            "【核心因果规则】：",
                            ...
                            "2. 若用户只是在交代事情、让你等待、还在忙碌中或普通闲聊（例如：“OK，你先去买咖啡吧”、“还在洗呢”、“在开会等我下班”）：",
        ...
        if (options?.returnedFromOffline) {
            llmMessages.push({
                role: "system",
                content: "【系统提示】你与用户刚刚结束了线下见面返回线上。请给用户主动发一条自然的线上消息（如报平安“我到家了”、或者回忆刚才线下见面的余韵）。",
            });
        }
