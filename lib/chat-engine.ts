    ...
    if (session.enableOfflineInvite && !session.isGroup) {
        llmMessages.push({
            ...
            content: [
                ...
                "   示例E（已知地点·被拒后强行动身·白红警报）：[线下邀约:强行动身:蜗居公寓606:20分钟:谁准你拒绝了？门反锁了我也在门外站一整夜，我这就过去|我已经在去你公寓的路上了，老老实实呆着别乱跑|车速开得很快，想着你刚才说的那句话我心里直发慌，耐心等我|我车停你楼下了，下来开门好不好？|站着别动，我这就朝你走过去]",
