            ...
            if (pendingInvite.status === "on_the_way") {
                ...
                llmMessages.push({
                    ...
                    content: [
                        ...
                        "  * 【一旦你在交流中同意由对方前来找你】：必须在回复末尾附带指令：`[更改地点:我去:新碰头地点:现场等候语]`（例如：`[更改地点:我去:老地方咖啡厅:点好了热饮，在窗边位置等你过来，慢慢走不着急]`）；",
                        ...
                        "- 【严禁无故重复发起全新邀约】：你已经在动身赶往见面的路上了，正常沟通闲聊中【严禁】重复输出[线下邀约]或[提醒赴约]指令；但【完全允许在碰头地点变动或碰头方向转换时使用[更改地点]指令】！",
                    ].join("\n"),
                });
